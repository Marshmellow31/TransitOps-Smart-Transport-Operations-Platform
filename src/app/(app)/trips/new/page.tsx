...
export default async function NewTripPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <Link href="/trips" className="text-sm text-zinc-500 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors flex items-center gap-1 mb-2">
        ...
        <h1 className="font-display text-[26px] font-bold text-[#14161e] dark:text-[#e8eaf0]">New Trip</h1>
        <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-0.5">Only available vehicles and drivers with valid licenses are shown.</p>
      </div>
